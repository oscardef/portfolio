...
My Bachelor's thesis at the University of Groningen. The problem was pretty straightforward: researchers in the AI lab spent too much time on administrative tasks — tracking papers, managing experiments, coordinating dataset annotations — when better tooling could handle most of it. So I built that tooling.
...
- Scoping a full-stack app solo under a thesis deadline teaches you to cut ruthlessly — and to know what's actually important
- My initial design assumptions were wrong in several places. Watching researchers actually use the prototype changed the direction significantly
- Got a lot better at database design for search-heavy workloads
- Learned to write a thesis that satisfies both the technical implementation and the academic writing requirements
